...
public interface SubmissionMapper {
    ...
    @Insert("insert into submission(ProblemId,submissionIdFromCF,contestId,ProblemIndex,actime,handle,ProblemRating,verdict) " +
            "values(#{ProblemId},#{submissionIdFromCF},#{contestId},#{ProblemIndex},#{actime},#{handle},#{ProblemRating},#{verdict})")
